...
{
    public static class SecurityOld
    {
        ...
        public static void SetFileOrFolderOwner(String objectName) //Note this is very basic and is silent on fail as I havent checked GetlastError and thrown an exception etc
        {
            ...
            ConvertStringSidToSid(identity.User.ToString(), ref sidPtr);
            Console.WriteLine(sidPtr.ToString());
            Console.WriteLine(SetNamedSecurityInfoW(objectName, SE_OBJECT_TYPE.SE_FILE_OBJECT, sFlags, sidPtr, IntPtr.Zero, IntPtr.Zero, IntPtr.Zero));
